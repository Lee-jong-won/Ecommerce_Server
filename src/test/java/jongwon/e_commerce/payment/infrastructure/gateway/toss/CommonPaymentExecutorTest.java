...
class CommonPaymentExecutorTest {
    ...
    void 정상_응답이_돌아올_경우_PayApproveSuccess를_반환한다(){
        // given
        commonPaymentExecutor = new CommonPaymentExecutor(new StubPaymentRestApproveClientNormal(), tossExceptionTranslator);
    ...
    void 카드_정보가_잘못됐을_경우_INVALID_CARD를_반환한다(){
        // given
        commonPaymentExecutor = new CommonPaymentExecutor(new StubPaymentRestApproveClientErrorResponse(), tossExceptionTranslator);
        PayApproveAttempt request = new PayApproveAttempt("a4CWyWY5m89PNh7xJwhk1",
                "5EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1",
                10000);
    ...
    void ReadTimeout이_발생하는_경우_ReadTimeout을_반환한다(){
        // given
        commonPaymentExecutor = new CommonPaymentExecutor(new StubPaymentRestApproveClientReadTimeout(), tossExceptionTranslator);
        PayApproveAttempt request = new PayApproveAttempt("a4CWyWY5m89PNh7xJwhk1",
                "5EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1",
                10000);
    ...
    void ConnTimeout이_발생하는_경우_ConnTimeout을_반환한다(){
        // given
        commonPaymentExecutor = new CommonPaymentExecutor(new StubPaymentRestApproveClientConnTimeout(), tossExceptionTranslator);
        PayApproveAttempt request = new PayApproveAttempt("a4CWyWY5m89PNh7xJwhk1",
                "5EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1",
                10000);
    ...
    void 커넥션_요청_타임아웃이_발생하는_경우_ConnectionRequestTimeout을_반환한다(){
        // given
        commonPaymentExecutor = new CommonPaymentExecutor(new StubPaymentRestApproveClientConnRequestTimeout(), tossExceptionTranslator);
        PayApproveAttempt request = new PayApproveAttempt("a4CWyWY5m89PNh7xJwhk1",
                "5EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1",
                10000);
