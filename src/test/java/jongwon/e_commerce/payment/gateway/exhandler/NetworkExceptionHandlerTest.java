...
class NetworkExceptionHandlerTest {

    NetworkExceptionHandler networkExceptionHandler = new NetworkExceptionHandler();
    ...
    void read_timeout이면_PayApproveTimeout을_반환한다() {
        ...
        // when
        PayApproveOutcome result = networkExceptionHandler.handle(ex);
